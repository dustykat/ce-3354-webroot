...
DATE & TOPIC & READINGS  \\
\hline
\texttt{22AUG24} & Introduction & SN  \\ %0
\texttt{27AUG24} & Specialized Software & RSG(pp.781-802) \\ %1 
\texttt{29AUG24} & Hydrologic Cycle  & RSG(pp.39-46);CMM(pp.1-12)\\ %2 water budget(s)
...
\texttt{12SEP24} & Streamflow and Hydrographs & RSG(pp.93-123;);CMM(pp.127-175)\\ %6
\texttt{17SEP24} & WCOE Job Fair (Civil Engineering)   &   \\ %7
\texttt{19SEP24} & Floods and Flood Frequency Analysis & RSG(pp.442-469);CMM(pp.380-416) \\ %8
