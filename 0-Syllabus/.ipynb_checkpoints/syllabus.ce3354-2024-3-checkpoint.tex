...
DATE & TOPIC & READINGS  \\
\hline
\texttt{22AUG24} & Introduction & RSG(pp.1-2); SN  \\ %0
\texttt{27AUG24} & Specialized Software & RSG(pp.781-802); SN \\ %1 
\texttt{29AUG24} & Hydrologic Cycle  & RSG(pp.39-46); CMM(pp.1-12); SN \\ %2 water budget(s)
...
\texttt{24SEP24} & Precipitation, Hyetographs, Design Storms &  RSG(pp.46-59); CMM(pp. ); SN \\  %9 NOAA Atlas 14, PFDS, Create design storm
...
\texttt{10OCT24} & Unit Hydrographs & RSG(pp.350-361); CMM(pp.XXX-XXX); LS(pp.XXX-XXX); SN\\ %13
\texttt{15OCT24} & Synthetic Unit Hydrographs &  RSG(pp.362-371); CMM(pp.XXX-XXX); LS(pp.XXX-XXX); SN  \\ %14
