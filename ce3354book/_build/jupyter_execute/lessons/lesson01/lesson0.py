...
# ## Course Resources
# - Software
# 1. JupyterLab (This type of document)
# 2. PeakFQ 7+
# 3. HEC-HMS
# 4. AWS Lightsail (cloud compute servers; an option to keep your local machine clean - requires Internet connection)
# 
# - Tour of the webbook:
# 1. Lessons
# 2. Exercises
...
# - Tour of Blackboard:
# 1. Lesson Links
# 2. Exercise Upload Links
# 3. Weekly Quiz
# 4. Project Upload Link
